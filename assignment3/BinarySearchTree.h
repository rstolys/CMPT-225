...
class BinarySearchTree
{
  public:
    ///////////////////////////////////////////////////////////////////
    /// ipl -- will compute the internal path length of the tree
    ///
    /// @param[out]     ipl         internal path length of the tree
    ///
    ///////////////////////////////////////////////////////////////////
    int ipl()
        {
  ...
  private:
    ...
    ///////////////////////////////////////////////////////////////////
    /// **private** ipl -- will compute the internal path length of the tree
    ///
    /// @param[in]     t            Pointer to binary search tree node
    /// @param[in]     myDepth      current depth of node
    ///
    /// @param[out]     int         internal path length of the tree
    ///
    ///////////////////////////////////////////////////////////////////
    int computeIPL(BinaryNode* t, int myDepth)
        { 
        int myIPL = 0;    

        if(t != nullptr)
            {
            myIPL = myDepth;            //The IPL is at minimum this nodes depth 
    ...
    ///
    ///////////////////////////////////////////////////////////////////
    int computeHeight(BinaryNode* t)
        { 
        int treeHeight = 0;
